    ...
    public partial class RepetierClient : Print3dServerClient, IPrint3dServerClient
    {
        ...
        public async Task<byte[]> GetDynamicRenderImageAsync(long modelId, bool thumbnail, int timeout = 20000, string? targetUri = "dyn/render_image")
        {
            try
            {
                ...
                if (RestClient is null) return resultObject;
                ...
                {
                    using HttpResponseMessage response = await client.GetAsync(fullUrl, HttpCompletionOption.ResponseHeadersRead);
                    bytes = await response.Content.ReadAsByteArrayAsync().ConfigureAwait(false);
                }
                */
                /**/
                bytes = await RestClient.DownloadDataAsync(request, cts.Token).ConfigureAwait(false);
                
                /*
                HttpClient ??= new();
                bytes = await HttpClient.GetByteArrayAsync(fullUrl).ConfigureAwait(false);
                */
        ...
        public async Task<byte[]> GetDynamicRenderImageByJobIdAsync(long jobId, bool thumbnail, int timeout = 20, string? targetUri = "dyn/render_image")
        {
            try
            {
                byte[] resultObject = [];
                ...
                */
                // Takes very long?!
                //HttpClient ??= new();
                //byte[]? bytes = await HttpClient.GetByteArrayAsync(fullUrl).ConfigureAwait(false);
                return bytes ?? resultObject;
            }
            catch (Exception exc)
            {
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                   ...
                   printerName: printerName)
                    .ConfigureAwait(false);
                */
                return GetObjectFromJsonSystem<RepetierJobListRespone>(result?.Result, DefaultJsonSerializerSettings);
            }
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                   ...
                   printerName: printerName
                    ...
                    .ConfigureAwait(false);
                */
                return GetObjectFromJsonSystem<RepetierWebCallList>(result?.Result, DefaultJsonSerializerSettings);
            }
            catch (JsonException jecx)
            {
                OnError(new JsonConvertEventArgs()
        ...
        */
        ...
        public async Task LoginAsync(string userName, SecureString password, string sessionId, bool remember = true)
        {
            ...
            string command =
                $"{{\"action\":\"login\",\"data\":{{\"login\":\"{userName}\",\"password\":\"{encryptedPassword}\",\"rememberMe\":{(remember ? "true" : "false")}}},\"printer\":\"{GetActivePrinterSlug()}\",\"callback_id\":{99}}}";
            await SendWebSocketCommandAsync(command).ConfigureAwait(false);
        }
        ...
        public async Task<RepetierAvailableUpdateInfo?> GetAvailableServerUpdateAsync()
        {
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                    ...
                    .ConfigureAwait(false);
                */
                return GetObjectFromJsonSystem<RepetierAvailableUpdateInfo>(result?.Result, DefaultJsonSerializerSettings);
            }
            catch (JsonException jecx)
            {
                OnError(new JsonConvertEventArgs()
        ...
        public async Task<RepetierLicenseInfo?> GetLicenseDataAsync()
        {
            ...
            try
            {
                ...
                */
                if (result is not null)
                {
                    return GetObjectFromJsonSystem<RepetierLicenseInfo>(result?.Result, DefaultJsonSerializerSettings);
                }
                else
                    return null;
            }
        ...
        public async Task RefreshJobListAsync()
        {
            try
            {
                ...
                Jobs = result is not null ? [with(result.Data)] : jobList;
            }
            catch (Exception exc)
            {
                OnError(new UnhandledExceptionEventArgs(exc, false));
        ...
        public async Task<bool> SetShutdownAfterPrintAsync(bool shutdown)
        {
            try
            {
                ...
                IRestApiRequestRespone? result = await SendRestApiRequestAsync(
                       ...
                       body: new { shutdown = shutdown ? "true" : "false" },
                       authHeaders: AuthHeaders
                       )
                    .ConfigureAwait(false);
                /*
        ...
        public async Task<Dictionary<string, RepetierPrinterState>?> GetStatesAsync(string printerName = "")
        {
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                    ...
                    .ConfigureAwait(false);
                */
                Dictionary<string, RepetierPrinterState>? state = GetObjectFromJsonSystem<Dictionary<string, RepetierPrinterState>>(result?.Result, DefaultJsonSerializerSettings);
        ...
        public async Task<ObservableCollection<RepetierCurrentPrintInfo>> GetCurrentPrintInfosAsync(string printerName = "")
        {
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                    ...
                    .ConfigureAwait(false);
                RepetierCurrentPrintInfo[]? info = GetObjectFromJsonSystem<RepetierCurrentPrintInfo[]>(result?.Result, DefaultJsonSerializerSettings);
                if (info is not null)
                {
        ...
        public async Task SetExtruderActiveAsync(int extruder)
        {
            try
            {
                ...
                _ = await SendGcodeAsync(command: "send", data: new { cmd }).ConfigureAwait(false);
            }
            catch (Exception exc)
            {
                OnError(new UnhandledExceptionEventArgs(exc, false));
        ...
        public async Task<bool> HomeAsync(bool x, bool y, bool z)
        {
            try
            {
                ...
                else
                {
                    ...
                    result = await SendGcodeAsync(command: "send", data: new { cmd }).ConfigureAwait(false);
                }
                return result;
            }
            catch (Exception exc)
        ...
        public async Task<bool> SetChamberTemperatureAsync(int chamberId, int temperature)
        {
            try
            {
                ...
                IRestApiRequestRespone? result = await SendRestApiRequestAsync(
                       ...
                       body: new { temperature, chamberId },
                       authHeaders: AuthHeaders
                       )
                    .ConfigureAwait(false);
                */
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                   ...
                   command: "listExternalCommands")
                    .ConfigureAwait(false);
                */
                ExternalCommand[]? cmds = GetObjectFromJsonSystem<ExternalCommand[]>(result?.Result, DefaultJsonSerializerSettings);
        ...
        public async Task<bool> RemoveMessageAsync(RepetierMessage message, bool unPause = false)
        {
            try
            {
                ...
                IRestApiRequestRespone? result = await SendRestApiRequestAsync(
                       ...
                       body: new { id = message.Id, a = unPause ? "unpause" : "" },
                       authHeaders: AuthHeaders
                       )
                    .ConfigureAwait(false);
                /*
        ...
        public async Task<ObservableCollection<RepetierMessage>> GetMessagesAsync(string printerName = "")
        {
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                    ...
                    .ConfigureAwait(false);
                */
                RepetierMessage[]? info = GetObjectFromJsonSystem<RepetierMessage[]>(result?.Result, DefaultJsonSerializerSettings);
                if (info is not null)
                    resultObject = [with(info)];
                return resultObject;
            }
        ...
        public async Task<RepetierGcodeScript?> GetGcodeScriptAsync(string scriptName)
        {
            ...
            try
            {
                ...
                */
                return GetObjectFromJsonSystem<RepetierGcodeScript>(result?.Result, DefaultJsonSerializerSettings);
            }
            catch (JsonException jecx)
            {
                OnError(new JsonConvertEventArgs()
        ...
        public async Task<bool> SetGcodeScriptAsync(string scriptName, string script)
        {
            try
            {
                ...
                object cmd = new { name = scriptName, script };
                string targetUri = $"{RepetierCommands.Base}/{RepetierCommands.Api}/{currentPrinter}";
                IRestApiRequestRespone? result = await SendRestApiRequestAsync(
                       requestTargetUri: targetUri,
                       method: Method.Post,
                       ...
                       body: cmd,
                       authHeaders: AuthHeaders
                       //urlSegments: new() { { "data", JsonConvert.SerializeObject(cmd) } }
                       )
                    .ConfigureAwait(false);
                /*
                RepetierApiRequestRespone result = await SendRestApiRequestAsync(
        ...
        public async Task<bool> ExecuteWebCallAsync(RepetierWebCallAction action, int timeout = 1500)
        {
            try
            {
                ...
                IRestApiRequestRespone? result = await SendRestApiRequestAsync(
                       ...
                       body: new { name = action.Name, @params = new string[] { action.Question } },
                       authHeaders: AuthHeaders
                       )
                    .ConfigureAwait(false);
                /*
        ...
        public async Task<byte[]?> DownloadFileFromUriAsync(Uri? uri)
        {
            try
            {
                ...
                */
                /**/
                HttpClient ??= new();
                bytes = await HttpClient.GetByteArrayAsync(uri).ConfigureAwait(false);
                return bytes;
        ...
        public async Task<RepetierProjectsServerListRespone?> GetProjectsListServerAsync(string printerName = "")
        {
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                    ...
                    .ConfigureAwait(false);
                */
                return GetObjectFromJsonSystem<RepetierProjectsServerListRespone>(result?.Result, DefaultJsonSerializerSettings);
            }
            catch (JsonException jecx)
            {
                OnError(new JsonConvertEventArgs()
        ...
        public async Task<RepetierProjectsFolderRespone?> GetProjectsGetFolderAsync(Guid serverUuid, int index = 1, string printerName = "")
        {
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                    ...
                    .ConfigureAwait(false);
                return GetObjectFromJsonSystem<RepetierProjectsFolderRespone>(result?.Result, DefaultJsonSerializerSettings);
            }
            catch (JsonException jecx)
            {
                OnError(new JsonConvertEventArgs()
        ...
        public async Task<RepetierProjectsProjectRespone?> GetProjectsGetProjectAsync(Guid serverUuid, Guid projectUuid, string printerName = "")
        {
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                    ...
                    .ConfigureAwait(false);
                return GetObjectFromJsonSystem<RepetierProjectsProjectRespone>(result?.Result, DefaultJsonSerializerSettings);
            }
            catch (JsonException jecx)
            {
                OnError(new JsonConvertEventArgs()
            ...
            string printerNameForHistory, string serverUuid = "", int limit = 50, int page = 0, int start = 0, bool allPrinter = false)
        {
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                    ...
                    .ConfigureAwait(false);
                return GetObjectFromJsonSystem<RepetierHistoryListRespone>(result?.Result, DefaultJsonSerializerSettings);
            }
            catch (JsonException jecx)
            {
                OnError(new JsonConvertEventArgs()
        ...
        async Task<RepetierHistorySummaryRespone?> GetHistorySummaryAsync(string printerNameForHistory, int year, bool allPrinter = false)
        {
            ...
            try
            {
                ...
                result = await SendRestApiRequestAsync(
                    ...
                    .ConfigureAwait(false);
                return GetObjectFromJsonSystem<RepetierHistorySummaryRespone>(result?.Result, DefaultJsonSerializerSettings);
            }
            catch (Exception exc)
            {
                OnError(new UnhandledExceptionEventArgs(exc, false));
        ...
        public async Task<byte[]?> GetHistoryReportAsync(long reportId, string printerName = "")
        {
            try
            {
                ...
                byte[]? report = await DownloadFileFromUriAsync($"{FullWebAddress}/printer/export/{printerName}?a=history_report&id={reportId}")
                    .ConfigureAwait(false)
                    ;
                return report;
            }
        ...
        async Task<RepetierGpioListRespone?> GetGPIOListResponeAsync()
        {
            ...
            try
            {
                ...
                */
                ...
                return GetObjectFromJsonSystem<RepetierGpioListRespone>(result?.Result, DefaultJsonSerializerSettings);
            }
            catch (Exception exc)
            {
                OnError(new UnhandledExceptionEventArgs(exc, false));
